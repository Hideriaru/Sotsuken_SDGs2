...
function generate_top_content() {
    var ins = '<img src="quizfont.png" alt="">';
    ins += '<img  src="3mon.png" alt="">';
...
function generate_quiz_content() {
    var ins = '<img class="saizu" src="quizfont2.png" alt="">';
    ins += '<div class="waku">';
    ...
    ins += '<p id="p2">' + quizData['quiz'][currentQuizNo]['hinto'] + '</p>';
    ins += '</ol>';
    ins += '</div>';
...
function generate_result_content() {
    var ins = '<div class="waku">'+ '<h1 class="p-quiz-ttl">結果は' + (currentQuizNo+1) + '問中' + correctCount + '問正解でした</h1>';
